...
template <typename type>
int log_histogram(std::deque<type> &c, std::ostream & out, int number_of_bins)
...
template <typename type>
int not_norm_histogram_correlated(std::deque<type> &c, std::deque<type> &d, std::ostream & out, int number_of_bins, double b1, double b2) {
...
template <typename type>
int not_norm_histogram(std::vector<type> &c, std::ostream & out, int number_of_bins, double b1, double b2) {
  // this should be OK
  // c is the set of data, b1 is the lower bound, b2 is the upper one (if they are equal, default limits are used)
...
template <typename type>
int not_norm_histogram(std::deque<type> &c, std::ostream & out, int number_of_bins, double b1, double b2) {
  // this should be OK
  // c is the set of data, b1 is the lower bound, b2 is the upper one (if they are equal, default limits are used)
...
int int_histogram(std::vector <int> &c, std::ostream & out) {
  ...
  for (std::map<int, double>::iterator it = hist.begin(); it != hist.end(); ++it)
  {
