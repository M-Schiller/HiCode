...
public:
  ...
  void printNetworkAsPajek(const std::string& filename);
...
private:
  ...
  void parsePajekNetwork(const std::string& filename);
  void parseLinkList(const std::string& filename);
  void parseSparseLinkList(const std::string& filename);
  void parsePajekNetworkCStyle(const std::string& filename);
  bool parseEdgeCStyle(char line[], unsigned int& sourceIndex, unsigned int& targetIndex, double& weight);
  void parseLinkListCStyle(const std::string& filename);
