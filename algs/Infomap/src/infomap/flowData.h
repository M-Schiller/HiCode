...
public:
  ...
  FlowDirected(const FlowDirected& other) = default;
...
public:
  ...
  FlowDirectedNonDetailedBalance(const FlowDirectedNonDetailedBalance& other) = default;

  FlowDirectedNonDetailedBalance& operator=(const FlowDirectedNonDetailedBalance& other) = default;
...
public:
  ...
  FlowDirectedNonDetailedBalanceWithTeleportation(const FlowDirectedNonDetailedBalanceWithTeleportation& other) = default;

  FlowDirectedNonDetailedBalanceWithTeleportation& operator=(const FlowDirectedNonDetailedBalanceWithTeleportation& other) = default;
...
public:
  ...
  FlowDummy(const FlowDummy& other) = default;
  ...
  FlowDummy& operator=(const FlowDummy& other) = default;
